          ...
          >
            <div className="flex items-center gap-[10px]">
              ...
              <div className="flex flex-col">
                <span className="text-[13px] font-semibold text-text">{addon.name}</span>
            ...
            <div className="flex items-center gap-[9px]">
              ...
              <div className={`w-9 h-5 rounded-[10px] relative transition-colors duration-250 shrink-0 ${isOn ? 'bg-brand' : 'bg-surface-3'}`}>
